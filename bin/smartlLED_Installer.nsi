...
!define PRODUCT_PUBLISHER "宁理邓俊锴"
...
!define SOURCE_PATH "E:\iacg\smartLED\*.*"
...
Function .onInit
  InitPluginsDir
  File "/oname=$PLUGINSDIR\bgm_Old_Memory.mp3" ".\Old Memory.mp3"
  ; 打开音乐文件
  System::Call "winmm.dll::mciSendString(t 'OPEN $PLUGINSDIR\bgm_Old_Memory.mp3 TYPE MPEGVIDEO ALIAS BGMUSIC', t .r0, i 130, i 0)"
  ; 开始播放音乐文件
